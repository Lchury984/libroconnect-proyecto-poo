...
import com.mycompany.vistas.Reports;
import com.mycompany.vistas.Books;
import com.mycompany.vistas.Returns;
import com.mycompany.vistas.Principal;
import com.mycompany.vistas.Users;
import com.mycompany.vistas.Lendings;
...
public class Inicio extends javax.swing.JFrame {
    ...
    //CONSTRUCTOR- aqui se inicializan los componentes de la interfaz grafica 
    public Inicio() {
    ...
    /*
        Métodos InitStyles(), SetDate() y InitContent():

        InitStyles(): Aplica estilos a los componentes de la interfaz gráfica.
        SetDate(): Establece la fecha actual en un componente de texto en un formato específico.
        InitContent(): Inicializa el contenido principal de la aplicación mostrando el panel Principal.
        */
    ...
    /*
    Método ShowJPanel(JPanel p):

    Este método muestra el panel PRINCIPAL en el contenido principal de la aplicación.
    Configura el tamaño y la posición del panel pasado como parámetro y lo añade al contenido principal.
    ...
    */
    ...
    private void initComponents() {
        ...
        btn_returns.setBackground(new java.awt.Color(0, 204, 204));
