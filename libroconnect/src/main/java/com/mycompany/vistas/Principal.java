...
public class Principal extends javax.swing.JPanel {
    ...
    Luego se llama al método InitStyles() para establecer estilos en los componentes del panel.
    */
    public Principal() {
        initComponents();
        InitStyles();
    ...
    Establece estilos para los componentes de la interfaz gráfica, como colores y fuentes de texto para los distintos JLabel.
    */
    ...
    */
    ...
    El panel contiene varios JLabel que muestran información acerca del sistema de gestión para una biblioteca pública.
    Se establecen mensajes de bienvenida, descripción del sistema, funcionalidades disponibles y secciones de reportes.
    La configuración visual incluye el uso de imágenes y disposición de los componentes en el panel.
    */
