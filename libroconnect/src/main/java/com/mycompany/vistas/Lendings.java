...
public class Lendings extends javax.swing.JPanel {
    ...
    Establece estilos para los componentes de la interfaz gráfica, como 
    colores y texto de marcador para los campos de texto folioTxt y libroIdTxt.
    */
    ...
    y contiene la configuración visual de los componentes en el panel.
    */
    ...
    /*
    Método buttonActionPerformed(java.awt.event.ActionEvent evt):

    Este método se ejecuta cuando se hace clic en el botón "Prestar".
    Realiza validaciones sobre los campos de texto folioTxt y libroIdTxt.
    Verifica la existencia del usuario y del libro en la base de datos a través de objetos DAO (DAOUsersImpl y DAOBooksImpl).
    Comprueba la disponibilidad del libro y si el usuario ya tiene prestado ese libro.
    En caso de cumplir con las validaciones, registra el préstamo del libro, 
    actualiza la disponibilidad del libro y muestra un mensaje de éxito.
    */
