...
public class Users extends javax.swing.JPanel {
    ...
    como el texto y color de las etiquetas, y establece un placeholder para el campo de búsqueda.
    */
    ...
    Utiliza un objeto DAOUsers para obtener la lista de usuarios y cargarla en la tabla. 
    La información se recupera de la base de datos y se muestra en la tabla.
    */
    ...
    /*
    Método addButtonActionPerformed():

    Abre una nueva instancia de la clase UpUsers para permitir el registro de un nuevo usuario.
    */
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        Inicio.ShowJPanel(new UpUsers());
    }//GEN-LAST:event_addButtonActionPerformed

    
    /*
    Método deleteButtonActionPerformed():

    Elimina uno o más usuarios seleccionados en la tabla. 
    Utiliza un DAOUsers para eliminar los usuarios de la base de datos y actualiza la tabla.
    */
    ...
    /*
    Método editButtonActionPerformed():

    Abre una instancia de la clase UpUsers para permitir la edición de un usuario seleccionado en la tabla.
    */
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            try {
                ...
                DAOUsers dao = new DAOUsersImpl();
                Inicio.ShowJPanel(new UpUsers(dao.getUserById(userId)));
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        } else {
    ...
    /*
    Método searchButtonActionPerformed():

    Realiza una búsqueda de usuarios según el texto ingresado en el campo de búsqueda. 
